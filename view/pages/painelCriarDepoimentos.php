...
<head>
	...
	<title>ACME Calçados | Painel Criar Depoimentos</title>
...
<body>
				...
				<div class="centroListagem">
					...
					<div class="itensListagem">
						<div class="formuNewPromo">
							<form method="POST" action="#" id="form_new_depoimento" enctype="multipart/form-data">
								<div class="box-form-geral">
									<div>
										<label for="nome">NOME:</label>
										<input type="text" name="nm_depoimento" id="nm_depoimento" required>
									</div>
								
									<div>
										<label for="descricao">DESCRIÇÃO:</label>
										<input type="text" name="ds_depoimento" id="ds_depoimento" required>	
									</div>
    ...
    <script src="<?php echo PATH_LINKS ?>/assets/js/depoimento.js"></script>
